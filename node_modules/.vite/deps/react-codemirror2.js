...
var require_dist2 = __commonJS({
  "../../../../../node_modules/@codemirror/view/dist/index.cjs"(exports) {
    ...
    var clipboardInputFilter = state.Facet.define();
    var clipboardOutputFilter = state.Facet.define();
    ...
    var scrollHandler = state.Facet.define();
    var ScrollTarget = class _ScrollTarget {
      ...
      clip(state$1) {
        return this.range.to <= state$1.doc.length ? this : new _ScrollTarget(state.EditorSelection.cursor(state$1.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
      }
    };
    var scrollIntoView = state.StateEffect.define({ map: (t, ch) => t.map(ch) });
    var setEditContextFormatting = state.StateEffect.define();
    ...
    var outerDecorations = state.Facet.define();
    ...
    function copiedRange(state2) {
      ...
      return { text: textFilter(state2, clipboardOutputFilter, content.join(state2.lineBreak)), ranges, linewise };
    }
    ...
    function runHandlers(map, event, view, scope) {
      ...
      if (scopeObj) {
        ...
        !(browser.windows && event.ctrlKey && event.altKey) && (baseName = w3cKeyname.base[event.keyCode]) && baseName != name) {
          if (runFor(scopeObj[prefix + modifiers(baseName, event, true)])) {
            handled = true;
          } else if (event.shiftKey && (shiftName = w3cKeyname.shift[event.keyCode]) != name && shiftName != baseName && runFor(scopeObj[prefix + modifiers(shiftName, event, false)])) {
            handled = true;
          }
      ...
      */
      static forRange(view, className, range) {
        if (range.empty) {
          ...
          return [new _RectangleMarker(className, pos.left - base.left, pos.top - base.top, null, pos.bottom - pos.top)];
        } else {
    ...
    var showHoverTooltipHost = showTooltip.compute([showHoverTooltip], (state2) => {
      let tooltips2 = state2.facet(showHoverTooltip);
    ...
    var gutterWidgetClass = state.Facet.define();
    var defaults = {
      class: "",
    ...
    var lineNumberWidgetMarker = state.Facet.define();
...
var require_dist5 = __commonJS({
  "../../../../../node_modules/@codemirror/language/dist/index.cjs"(exports) {
    ...
    var ParseContext = class _ParseContext {
      ...
      */
      static create(parser, state2, viewport) {
        return new _ParseContext(parser, state2, [], common.Tree.empty, 0, viewport, [], null);
      }
      startParse() {
      ...
      update(folded, tr) {
        ...
        for (let e of tr.effects) {
          if (e.is(foldEffect) && !foldExists(folded, e.value.from, e.value.to)) {
            ...
            let widget = !preparePlaceholder ? foldWidget : view.Decoration.replace({ widget: new PreparedFoldWidget(preparePlaceholder(tr.state, e.value)) });
    ...
    var StreamLanguage = class _StreamLanguage extends Language {
      ...
      */
      ...
      getIndent(cx, pos) {
        ...
        let start = findState(this, tree, 0, at.from, from !== null && from !== void 0 ? from : pos), statePos, state2;
        if (start) {
          state2 = start.state;
    ...
    var alwaysIsolate = state.Facet.define({ combine: (values) => values.some((x) => x) });
    ...
    var isolateMarks = view.ViewPlugin.fromClass(class {
      constructor(view$1) {
        this.always = view$1.state.facet(alwaysIsolate) || view$1.textDirection != view.Direction.LTR || view$1.state.facet(view.EditorView.perLineTextDirection);
      ...
      update(update) {
        let always = update.state.facet(alwaysIsolate) || update.view.textDirection != view.Direction.LTR || update.state.facet(view.EditorView.perLineTextDirection);
      ...
      provide: (plugin) => {
        function access(view$1) {
          var _a2, _b;
          return (_b = (_a2 = view$1.plugin(plugin)) === null || _a2 === void 0 ? void 0 : _a2.decorations) !== null && _b !== void 0 ? _b : view.Decoration.none;
        }
        return [
          view.EditorView.outerDecorations.of(access),
          state.Prec.lowest(view.EditorView.bidiIsolatedRanges.of(access))
        ];
      }
    });
    function buildDeco(view2, tree, always) {
      let deco = new state.RangeSetBuilder();
      let ranges = view2.visibleRanges;
      if (!always)
        ranges = clipRTLLines(ranges, view2.state.doc);
...
var require_dist6 = __commonJS({
  "../../../../../node_modules/@codemirror/commands/dist/index.cjs"(exports) {
    ...
    var HistEvent = class _HistEvent {
      ...
      static fromJSON(json) {
        return new _HistEvent(json.changes && state.ChangeSet.fromJSON(json.changes), [], json.mapped && state.ChangeDesc.fromJSON(json.mapped), json.startSelection && state.EditorSelection.fromJSON(json.startSelection), json.selectionsAfter.map(state.EditorSelection.fromJSON));
      }
    ...
    function moveBySubword(view2, range, forward) {
      ...
      if (segmenter && cat == state.CharCategory.Word && end.from == range.from + steps * (forward ? 1 : -1)) {
        ...
        let skipped = view2.state.sliceDoc(from, to);
    ...
    var deleteCharBackwardStrict = (view2) => deleteByChar(view2, false, false);
    ...
    var deleteToLineStart = (view2) => deleteBy(view2, (range) => {
      let lineStart = view2.lineBlockAt(range.head).from;
    ...
    var deleteLine = (view2) => {
      ...
      let selection = updateSel(state2.selection, (range) => {
        ...
        if (view2.lineWrapping) {
          ...
          if (pos)
            dist = block.bottom + view2.documentTop - pos.bottom + view2.defaultLineHeight / 2;
        }
        return view2.moveVertically(range, true, dist);
      }).map(changes);
    ...
    var insertNewlineKeepIndent = ({ state: state$1, dispatch }) => {
    ...
    var temporarilySetTabFocusMode = (view2) => {
      view2.setTabFocusMode(2e3);
      return true;
    };
...
var require_dist8 = __commonJS({
  "../../../../../node_modules/@codemirror/search/dist/index.cjs"(exports) {
    ...
    function searchPanelOpen(state2) {
      var _a;
      return ((_a = state2.field(searchState, false)) === null || _a === void 0 ? void 0 : _a.panel) != null;
    }
  ...
  "../../../../../node_modules/@codemirror/autocomplete/dist/index.cjs"(exports) {
    ...
    var CompletionTooltip = class {
      constructor(view2, stateField, applyCompletion2) {
        ...
        this.dom.addEventListener("focusout", (e) => {
          let state2 = view2.state.field(this.stateField, false);
          if (state2 && state2.tooltip && view2.state.facet(completionConfig).closeOnBlur && e.relatedTarget != view2.contentDOM)
    ...
    var completionPlugin = view.ViewPlugin.fromClass(class {
      ...
      startQuery(active) {
        ...
        let context = new CompletionContext(state2, pos, active.explicitPos == pos, this.view);
      ...
      eventHandlers: {
        blur(event) {
          ...
          if (state2 && state2.tooltip && this.view.state.facet(completionConfig).closeOnBlur) {
            let dialog = state2.open && view.getTooltip(this.view, state2.open.tooltip);
    ...
    var commitCharacters = state.Prec.highest(view.EditorView.domEventHandlers({
      keydown(event, view2) {
    ...
    function snippet(template) {
      ...
      return (editor, completion, from, to) => {
        ...
        let spec = {
          ...
          scrollIntoView: true,
          annotations: completion ? [pickedCompletion.of(completion), state.Transaction.userEvent.of("input.complete")] : void 0
        };
        if (ranges.length)
    ...
    function hasNextSnippetField(state2) {
      let active = state2.field(snippetState, false);
      return !!(active && active.ranges.some((r) => r.field == active.active + 1));
    }
    function hasPrevSnippetField(state2) {
      let active = state2.field(snippetState, false);
    ...
    function insertBracket(state$1, bracket) {
      ...
      for (let tok of tokens) {
        ...
        if (bracket == tok)
          return closed == tok ? handleSame(state$1, tok, tokens.indexOf(tok + tok + tok) > -1, conf) : handleOpen(state$1, tok, closed, conf.before || defaults.before);
    ...
    function handleSame(state$1, token, allowTriple, config2) {
      ...
      let dont = null, changes = state$1.changeByRange((range) => {
        ...
        } else if (allowTriple && state$1.sliceDoc(pos - 2 * token.length, pos) == token + token && (start = canStartStringAt(state$1, pos - 2 * token.length, stringPrefixes)) > -1 && nodeStart(state$1, start)) {
          return {
    ...
    function probablyInString(state2, pos, quoteToken, prefixes) {
      ...
      for (let i = 0; i < 5; i++) {
        let start = state2.sliceDoc(node.from, Math.min(node.to, node.from + quoteToken.length + maxPrefix));
...
var require_dist10 = __commonJS({
  "../../../../../node_modules/@codemirror/lint/dist/index.cjs"(exports) {
    ...
    function diagnosticsTooltip(view2, diagnostics) {
      return elt("ul", { class: "cm-tooltip-lint" }, diagnostics.map((d) => renderDiagnostic(view2, d, false)));
    }
    ...
    var previousDiagnostic = (view2) => {
      let { state: state2 } = view2, field = state2.field(lintState, false);
      if (!field)
        return false;
      let sel = state2.selection.main;
      let prevFrom, prevTo, lastFrom, lastTo;
      field.diagnostics.between(0, state2.doc.length, (from, to) => {
      ...
      if (lastFrom == null || prevFrom == null && lastFrom == sel.from)
        return false;
      view2.dispatch({ selection: { anchor: prevFrom !== null && prevFrom !== void 0 ? prevFrom : lastFrom, head: prevTo !== null && prevTo !== void 0 ? prevTo : lastTo }, scrollIntoView: true });
      return true;
    };
    var lintKeymap = [
    ...
    function renderDiagnostic(view2, diagnostic, inPanel) {
      ...
      return elt("li", { class: "cm-diagnostic cm-diagnostic-" + diagnostic.severity }, elt("span", { class: "cm-diagnosticText" }, diagnostic.renderMessage ? diagnostic.renderMessage(view2) : diagnostic.message), (_a = diagnostic.actions) === null || _a === void 0 ? void 0 : _a.map((action, i) => {
    ...
    var LintGutterMarker = class extends view.GutterMarker {
      ...
      toDOM(view2) {
        ...
        if (diagnosticsFilter)
          diagnostics = diagnosticsFilter(diagnostics, view2.state);
